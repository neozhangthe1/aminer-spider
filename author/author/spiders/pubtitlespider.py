          ...
          if self.pointer in PriorityPeople:
            ...
            if len(pubs) == 0:
              ...
              for pub in pubs:
                ...
                request = Request(url, dont_filter = True,callback = self.parse, meta = {'dont_redirect':True,'dont_retry':True,'User-agent':random.choice(AGENTS),'aid':self.pointer,'handle_httpstatus_list':[302,503,200,307,403,404,502,500,504],'pid':pid,'title':title})
